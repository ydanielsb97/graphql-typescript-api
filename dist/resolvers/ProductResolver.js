...
var Products_repository_1 = require("../repository/Products.repository");
var ProductResolver = /** @class */ (function () {
    function ProductResolver(_productsRepository) {
        this._productsRepository = _productsRepository;
    }
    ProductResolver.prototype.createProduct = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // const result = await this._productsRepository.create(product);
                // console.log(this._productsRepository);
                return [2 /*return*/];
            });
        });
    };
