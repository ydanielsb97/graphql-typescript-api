...
var ProductRepository = /** @class */ (function (_super) {
    ...
    ProductRepository.prototype.createUser = function (createProductDto) {
    ...
    ProductRepository.prototype.updateById = function (id, updateProductDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.save(updateProductDto)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, { message: "eliminated" }];
                }
            });
        });
    };
